...
const JSON_PATH = path.join(__dirname, '..', '..', '..', 'Scrapping', 'exports', 'NVI_bolls.json');
...
async function main() {
  console.log('📖 Reimportando NVI desde JSON...\n');
  ...
  // 1. Eliminar todos los chapter_versions de NVI
